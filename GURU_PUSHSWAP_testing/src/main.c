...
/*   Updated: 2025/02/25 12:41:59 by gkamanur         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void print_stack(t_list *stack, char *name)
{
	...
	while (stack)
	{
		printf("[\033[1;32m%li\033[0m, %i, %i] ", stack->content, stack->index, stack->flag);
		stack = stack->next;
	}
	printf("\n");
}
...
int	main(int ac, char **ag)
{
	...
	printf("before index\n");
	print_stack(tab->stack_a, "a_flag_stack1");
	print_stack(tab->stack_b, "a_flag_stack2");
